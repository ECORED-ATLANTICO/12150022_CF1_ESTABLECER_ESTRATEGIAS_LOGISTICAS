...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-4.mb-lg-5
      .col-sm-10.col-lg-5
        figure
          img.mb-4.mb-lg-0(src="@/assets/curso/tema11/4.png", alt="" data-aos="zoom-in-down")
      .col-lg-7
            ...
            .col
              .row.justify-content-between.align-items-center
                .col.mb-3.mb-sm-0
                  ...
                  p.mb-0 A continuación, se invita a consultar el siguiente video para fortalecer los conocimientos relacionados con el diseño de operaciones en <em>cross docking</em> y su aplicación en los procesos de distribución y optimización logística:
